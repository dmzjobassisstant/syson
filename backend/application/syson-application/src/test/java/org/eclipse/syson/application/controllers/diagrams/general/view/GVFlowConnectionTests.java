...
/**
 * Tests on {@link FlowConnectionUsage} on the General View Diagram. Diagram .
 *
...
public class GVFlowConnectionTests extends AbstractIntegrationTests {
    ...
    public void checkFlowConnectionCreation() {
        ...
        this.semanticCheckerService.checkElement(this.verifier, FlowConnectionUsage.class, () -> newFlow[0], flow -> {
    ...
    public void reconnectFlowConnectionUsageTarget() {
        ...
        this.semanticCheckerService.checkElement(this.verifier, FlowConnectionUsage.class, () -> GeneralViewFlowConnectionItemUsagesProjectData.SemanticIds.FLOW_CONNECTION_ID, flowConnectionUsage -> {
            ...
            assertThat(this.identityService.getId(flowConnectionUsage.getTargetInputFeature().getOwnedRedefinition().get(0).getRedefinedFeature()))
                    .isEqualTo(GeneralViewFlowConnectionItemUsagesProjectData.SemanticIds.ACTION_USAGE_3_IN_ITEM_ID);
            assertThat(this.identityService.getId(flowConnectionUsage.getSourceFeature())).isEqualTo(GeneralViewFlowConnectionItemUsagesProjectData.SemanticIds.ACTION_USAGE_1_ID);
            assertThat(this.identityService.getId(flowConnectionUsage.getTargetFeature().get(0))).isEqualTo(GeneralViewFlowConnectionItemUsagesProjectData.SemanticIds.ACTION_USAGE_3_ID);
        });
    }
    ...
    public void reconnectFlowConnectionUsageSource() {
        ...
        this.semanticCheckerService.checkElement(this.verifier, FlowConnectionUsage.class, () -> GeneralViewFlowConnectionItemUsagesProjectData.SemanticIds.FLOW_CONNECTION_ID,
                flowConnectionUsage -> {
                    assertThat(this.identityService.getId(flowConnectionUsage.getSourceOutputFeature().getOwnedRedefinition().get(0).getRedefinedFeature()))
                    ...
                    assertThat(this.identityService.getId(flowConnectionUsage.getSourceFeature())).isEqualTo(GeneralViewFlowConnectionItemUsagesProjectData.SemanticIds.ACTION_USAGE_3_ID);
                    assertThat(this.identityService.getId(flowConnectionUsage.getTargetFeature().get(0))).isEqualTo(GeneralViewFlowConnectionItemUsagesProjectData.SemanticIds.ACTION_USAGE_2_ID);
                });
    }
