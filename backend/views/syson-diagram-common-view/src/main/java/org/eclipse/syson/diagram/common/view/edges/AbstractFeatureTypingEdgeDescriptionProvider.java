...
public abstract class AbstractFeatureTypingEdgeDescriptionProvider extends AbstractEdgeDescriptionProvider {
    ...
    public EdgeDescription create() {
        ...
        return this.diagramBuilderHelper.newEdgeDescription()
                ...
                .sourceExpression(AQLConstants.AQL_SELF + "." + SysmlPackage.eINSTANCE.getFeatureTyping_TypedFeature().getName())
                .style(this.createEdgeStyle())
                .synchronizationPolicy(SynchronizationPolicy.SYNCHRONIZED)
                .targetExpression(AQLConstants.AQL_SELF + "." + SysmlPackage.eINSTANCE.getFeatureTyping_Type().getName())
                .build();
    }
    ...
    private EdgeStyle createEdgeStyle() {
        return this.diagramBuilderHelper.newEdgeStyle()
                .borderSize(0)
                .color(this.colorProvider.getColor(EdgeColorPalette.FEATURE_TYPING_COLOR))
