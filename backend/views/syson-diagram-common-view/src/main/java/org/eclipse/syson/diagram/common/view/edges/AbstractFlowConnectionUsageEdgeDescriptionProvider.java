...
/**
 * Used to create an {@link FlowConnectionUsage} edge description.
 *
 * @author frouene
 */
public abstract class AbstractFlowConnectionUsageEdgeDescriptionProvider extends AbstractEdgeDescriptionProvider {

    private final ViewBuilders viewBuilderHelper = new ViewBuilders();

    private final DiagramBuilders diagramBuilderHelper = new DiagramBuilders();

    public AbstractFlowConnectionUsageEdgeDescriptionProvider(IColorProvider colorProvider) {
        super(colorProvider);
    }
    ...
    public EdgeDescription create() {
        String domainType = SysMLMetamodelHelper.buildQualifiedName(SysmlPackage.eINSTANCE.getFlowConnectionUsage());
    ...
    private EdgeStyle createEdgeStyle() {
        return this.diagramBuilderHelper.newEdgeStyle()
                .borderSize(0)
                .color(this.colorProvider.getColor(EdgeColorPalette.FLOW_CONNECTION_COLOR))
